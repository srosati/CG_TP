import { Object3D, Mesh, PlaneGeometry, MeshPhysicalMaterial } from "../../../build/three.module.js";
...
export default class House extends Object3D {
    constructor({
        ...
        super();
        this.floor = new Mesh(new PlaneGeometry(width, depth, 10, 10), new MeshPhysicalMaterial({ color: 0x937e7d}));
        ...
        this.leftWall = new Mesh(new PlaneGeometry(depth, height, 10, 10), new MeshPhysicalMaterial({ color: 0xeeeeee}));
        this.leftWall.position.z = -width / 2;
        this.leftWall.position.y = height / 2;
        
        this.rightWall = new Mesh(new PlaneGeometry(depth, height, 10, 10), new MeshPhysicalMaterial({ color: 0xeeeeee}));
        this.rightWall.position.z = width / 2;
        this.rightWall.position.y = height / 2;
        this.rightWall.rotateX(Math.PI);
        
        this.topWall = new Mesh(new PlaneGeometry(depth, height, 10, 10), new MeshPhysicalMaterial({ color: 0xeeeeee}));
        this.topWall.position.y = height / 2;
        this.topWall.position.x = width / 2;
        this.topWall.rotateY(-Math.PI / 2);
        
        this.bottomWall = new Mesh(new PlaneGeometry(depth, height ,10, 10), new MeshPhysicalMaterial({ color: 0xeeeeee}));
